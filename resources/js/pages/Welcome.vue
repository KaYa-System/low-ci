            ...
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    ...
                    <div class="mt-8 pt-6 border-t border-[#e3e3e0] dark:border-[#3E3E3A]">
                        <h2 class="mb-2 font-medium">Procédures et Guides</h2>
                        <p class="mb-4 text-[#706f6c] dark:text-[#A1A09A]">
                            Accédez rapidement aux procédures importantes pour votre travail quotidien.
                        </p>
                        <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                            <div class="rounded-lg border border-[#e3e3e0] bg-[#fafafa] p-4 dark:border-[#3E3E3A] dark:bg-[#1a1a1a]">
                                <h3 class="mb-2 font-medium text-sm">Procédures Techniques</h3>
                                <p class="text-xs text-[#706f6c] dark:text-[#A1A09A] mb-3">
                                    Guides pour les tâches techniques courantes
                                </p>
                                <a
                                    href="/procedures/techniques"
                                    class="inline-flex items-center text-xs font-medium text-[#f53003] hover:underline dark:text-[#FF4433]"
                                >
                                    Voir les procédures
                                    <svg
                                        width="10"
                            ...
                            <div class="rounded-lg border border-[#e3e3e0] bg-[#fafafa] p-4 dark:border-[#3E3E3A] dark:bg-[#1a1a1a]">
                                <h3 class="mb-2 font-medium text-sm">Procédures Qualité</h3>
                                <p class="text-xs text-[#706f6c] dark:text-[#A1A09A] mb-3">
                                    Processus de contrôle qualité et validation
                                </p>
                                <a
                                    href="/procedures/qualite"
                                    class="inline-flex items-center text-xs font-medium text-[#f53003] hover:underline dark:text-[#FF4433]"
                                >
                                    Voir les procédures
                                    <svg
                            ...
                            <div class="rounded-lg border border-[#e3e3e0] bg-[#fafafa] p-4 dark:border-[#3E3E3A] dark:bg-[#1a1a1a] sm:col-span-2 lg:col-span-1">
                                <h3 class="mb-2 font-medium text-sm">Procédures Sécurité</h3>
                                <p class="text-xs text-[#706f6c] dark:text-[#A1A09A] mb-3">
                                    Protocoles de sécurité et bonnes pratiques
                                </p>
                                <a
                                    href="/procedures/securite"
                                    class="inline-flex items-center text-xs font-medium text-[#f53003] hover:underline dark:text-[#FF4433]"
                                >
                                    Voir les procédures
                                    <svg
